...
#endif
#if defined(_MSC_VER)
#pragma warning(disable: 4297 4005)	//function assumed not to throw an exception but does + macro redefinition
#endif
...
extern "C" {
	...
	// jmorecfg.h проверяет макроопределения из basetsd.h, поэтому windows.h должен включаться раньше
	#include <jpeglib.h>
	#include <jerror.h>
