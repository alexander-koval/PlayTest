...
public:
	...
	EmitterMask* GetEmitterMask() const { return emitterMask; }
...
private:
	...
	void CreateTextureMask(const std::string& filename, uint8_t luminanceMin, uint8_t luminanceMax, float scaleX, float scaleY);
