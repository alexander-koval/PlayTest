...
namespace Render {
	...
	/// Класс текстуры
	class Texture : public Resource, public Bindable, public Drawable
	{
	...
	public:
		...
		virtual TextureType GetTextureType() const override { return TextureType::Texture; }
	...
	protected:
		...
		std::unique_ptr<utils::OpacityMask> mask;
