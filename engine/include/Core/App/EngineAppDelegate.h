...
public:
	...
	virtual void OnDrawSplash() {} // mac | здесь можно отрисовать сплеш, чтобы окно показалось сразу с картинкой, а не с серым фоном

	void InitPushNotifications(SoundSettings setting);
